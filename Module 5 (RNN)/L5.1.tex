...
\begin{multicols}{2}
\begin{center}
    \includegraphics[scale=0.8]{Module 4 (RNN)/pics/hopfield.pdf}
\end{center}
...
\begin{center}
    \includegraphics[scale = 0.25]{Module 4 (RNN)/pics/rnn_rolled.pdf}
    \end{center}
...
\begin{center}
    \includegraphics[scale = 0.2]{Module 4 (RNN)/pics/rnn_unrolled.pdf}
    \end{center}
\end{frame}
...
\begin{center}
    ...
    \includegraphics[scale = 0.4]{Module 4 (RNN)/pics/small_rnn.pdf}
    \end{center}
\end{frame}

\begin{frame}{Structure of the Elman RNN}{Unfolded compact representation of the RNN}
\begin{center}
    \includegraphics[scale = 0.35]{Module 4 (RNN)/pics/small_rnn_unrolled.pdf}
    \end{center}
\end{frame}

\begin{frame}{Structure of the Elman RNN}{Unfolded even more compact representation}
\begin{center}
    \includegraphics[scale = 0.35]{Module 4 (RNN)/pics/smaller_rnn_unrolled.pdf}
\end{center}
